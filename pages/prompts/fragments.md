...
## Blog description and tags metadata

```markdown
Generate a description and tags as metadata for this blog post. Format:
...
Tags are the smallest set of canonical topics that would help an AI agent decide whether this content is relevant.
