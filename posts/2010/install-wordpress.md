...
date: "2010-07-14T21:26:58Z"
categories:
  - open-source
wp_id: 2525
description: Install WordPress locally by unzipping files into your XAMPP htdocs folder. Create a database via phpMyAdmin, then run the setup at localhost using root credentials to access your new WordPress dashboard immediately.
keywords: [wordpress, xampp, phpmyadmin, localhost, local development, database configuration]
---
...
- **Rajasekar** _6 Oct 2010 6:01 am_:
  Hello Anand Brother . I m rajasekar currently working as a UI Designer in Chennai . U r site is nice... I m fresher. When i see u r website . They are many things to learn here..
