...
categories:
  ...
  - data
wp_id: 2554
description: I built a tool for Mixamail to shorten tweets while maintaining readability. By testing techniques like removing articles, substituting words, and stripping middle vowels on 150,000 sentences, I achieved a 22% reduction in text length.
keywords: [twitter, sentence shortening, data analysis, mixamail, natural language processing, tanaka corpus]
---
