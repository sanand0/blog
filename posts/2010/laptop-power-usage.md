...
categories:
  - how-i-do-things
wp_id: 2459
description: Using a digital wattmeter, I measured my Dell Latitude E5400's energy draw. I discovered that background color doesn't impact LCD power, while CPU load and screen brightness are the biggest factors. Wireless status had surprisingly little effect.
keywords: [digital wattmeter, dell latitude e5400, power consumption, lcd display, hardware testing, cpu load]
---
