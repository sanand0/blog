...
- **Convert the text to words**. [Splitting text into words is tricky](/blog/splitting-a-sentence-into-words/). For now, I'm simply assuming that any group of letters is a word, and anything that's not a letter is a word delimiter.
