...
categories:
  - how-i-do-things
wp_id: 2847
description: I compared hosting costs across GAE, Azure, and AWS. I chose Amazon EC2 spot instances in Singapore, using shell scripts for fast recovery to cut my monthly hosting bill from $230 to just $29.
keywords: [amazon ec2, spot instances, hosting costs, cloud infrastructure, latency, shell scripting]
---
