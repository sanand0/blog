---
title: Things I Learned - 04 Aug 2024
...
- [Assisted generation](https://huggingface.co/blog/assisted-generation) uses a faster LLM to generate text and a better (tokenizer-compatible) LLM to validate it. This makes it faster. E.g. [Gemma 2 2b with Gemma 2 27b](https://huggingface.co/blog/gemma-july-update)
...
- Interest Turing complete languages:
  ...
  - SQL
  - Excel
- [Rev.ai](https://rev.ai/) does a good job of diarization. Cost: 2 cents per minute. Update: 6 Jun 2025. Cost: 0.33c/min [Ref](https://www.rev.ai/pricing)
