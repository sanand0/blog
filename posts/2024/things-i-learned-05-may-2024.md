---
title: Things I Learned - 05 May 2024
...
- curl supports [globbing](https://everything.curl.dev/cmdline/urls/globbing.html), [emails](https://everything.curl.dev/usingcurl/smtp.html)
- [Beetrove](https://beetrove.com/) is a ranking of the popularit of OpenAI GPTs
- [Gemini Prompt Guide](https://inthecloud.withgoogle.com/gemini-for-google-workspace-prompt-guide/dl-cd.html) has detailed examples of how each role can use Gemini
