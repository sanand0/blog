---
title: Things I Learned - 07 Apr 2024
...
- This is a subtle vulnerability. ChatGPT hallucinated `pip install huggingface-cli`. So[someone created the package](https://www.lasso.security/blog/ai-package-hallucinations) and got 30,000 downloads!
- [Video-Llava](https://github.com/PKU-YuanGroup/Video-LLaVA) is a video LLM
- [MusicCNN-embeddings](https://github.com/minguezalba/MusiCNN-embeddings) provides embeddings for music genre classification
- [How I write podcast. Paul Graham essays](https://youtu.be/2OZ94b3fJvo)
