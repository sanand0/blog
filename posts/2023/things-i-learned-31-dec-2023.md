---
title: Things I Learned - 31 Dec 2023
...
- [Lica](https://www.lica.world/) has a fascinating demo of how a document can be converted into a video story.
...
- [Mini-GPTs](https://arxiv.org/abs/2312.12682) is an interesting approach to shrink LLMs and make them domain specific. It takes existing LLMs and removes neurons not used in a specific domain (e.g. law, medicine, etc.)
