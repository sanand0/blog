...
- **Cell Burner** _22 Sep 2008 6:28 am_:
  Suppose I want to download the entire imdb site, will downloading everything from the link you have given also give images of the movies? Because without images, I don't know what the point is.\
  \
  I came across another method to download imdb, as a TomeRaider (not Tombraider) ebook, and that is only 157 MB, so I am not sure if it contains images as well.
