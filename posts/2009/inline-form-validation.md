...
- Validate on blur, not on keypress (it's distracting, and users [can't multitask](http://www.azarask.in/blog/post/you-cant-multitask/))
...
- **jesse** _25 Sep 2009 4:15 pm_:
  maybe u should add some inline validation on your comments form, instead of the wordpress error page?
