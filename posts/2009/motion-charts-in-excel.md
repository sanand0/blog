...
categories:
  ...
  - tools
wp_id: 2331
description: I explain how to build animated motion charts in Excel by combining bubble charts with scroll bars and a simple VBA "play" script. This method allows you to visualize four dimensions of data over time.
keywords: [excel, motion charts, bubble charts, vba, vlookup, data visualization, hans rosling]
---
