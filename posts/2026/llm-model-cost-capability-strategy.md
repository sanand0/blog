...
categories:
- llms
description: I track LLM cost versus capability using Harry Potter-sized token costs and LMSYS scores, then compare how Claude, Gemini, and OpenAI have positioned their models across the frontier.
tags: [model-comparison, llm-pricing, llms]
---
