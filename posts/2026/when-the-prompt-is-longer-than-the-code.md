...
categories:
- llms
description: I used pi to create a 471-byte home page, though the prompts were longer than the code. The first draft helped me start, solve centering, and practice reviewing AI-written code.
tags: [ai-coding-agents, developer-workflow, web-development]
---
