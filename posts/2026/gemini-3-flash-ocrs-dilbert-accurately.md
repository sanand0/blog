...
The first step is to extract the text. [Pavan](https://github.com/pavankumart18) tested over half a dozen LLMs on ~30 Dilbert strips to see which one did the best.
