---
title: My changing AI opinions
date: 2026-06-05T09:41:33+08:00
categories:
- llms
description: I asked Claude to examine my AI writing and found six shifted opinions, five contradictions, and four assumptions I still hold—from frontier-model winners and MCP to verification, code, and using AI heavily.
tags: [mental-models, ai-agents, model-context-protocol, vibe-coding]
---
...
1. "Vibe code everything, end-to-end" _vs_ "Don't commit based on vibe-coding, it's not fully reliable".
2. "Experience is a liability" _vs_ "Domain expertise is an edge"
3. "Paid plans are fine for private data" _vs_ "Don't assume paid = private"
4. "Get out of the way / delegate everything" _vs_ "Verification is the whole job"
5. "Build, don't plan" _vs_ "Plan → Correct → Execute"
...
![](https://files.s-anand.net/images/2026-03-05-my-changing-ai-opinions.avif)
