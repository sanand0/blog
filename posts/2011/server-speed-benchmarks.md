...
categories:
  - coding
wp_id: 2618
description: I benchmarked Node.js against PHP, Tornado, and Nginx using a simple Hello World test. I found Node.js surprisingly faster than Nginx serving a static file, achieving 2,500 requests per second using the Apache Benchmark tool.
keywords: [node.js, nginx, apache benchmark, tornado, web server performance, php]
---
